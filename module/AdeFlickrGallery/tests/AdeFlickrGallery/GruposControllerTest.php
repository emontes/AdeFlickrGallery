<?php
use AdeFlickrGallery\Controller\GruposController;
 ...
 */
class GruposControllerTest extends AbstractHttpControllerTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->IndexController = new GruposController();
